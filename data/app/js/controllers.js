...
//        ,buttonText: '<i class=icon-calendar></i>'
    ...
    formModel.extractData = function() {
        ...
        terms.regularPayment = (typeof formModel.monthlyPayment === 'undefined' ||
                                typeof formModel.monthlyPayment === 'string')
                        ? "0" : formModel.monthlyPayment.toString();
